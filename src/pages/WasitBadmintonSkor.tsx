...
// 1. Buat seluruh props menjadi OPSIONAL (?) agar bisa dirender langsung di App.tsx
export interface WasitBadmintonScoreProps {
...
// 2. Berikan default fallback value untuk teams dan onCockUsed
export default function WasitBadmintonSkor({
    teams = [],
    onCockUsed,
    token
}: WasitBadmintonScoreProps) {
    ...
    return (
        <div className="min-h-screen bg-night text-cream p-4 sm:p-6 space-y-6">
